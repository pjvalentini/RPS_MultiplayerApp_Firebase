// Initialize Firebase
 var config = {
   apiKey: "AIzaSyDhcS0YgFysCdmVSR3KEO6eFhKy1gcXTy0",
   authDomain: "rps-multiplayer-challenge.firebaseapp.com",
   databaseURL: "https://rps-multiplayer-challenge.firebaseio.com",
   projectId: "rps-multiplayer-challenge",
   storageBucket: "",
   messagingSenderId: "956079179879"
 };
...
currentTurnRef.on("value", function(snapshot) {
  ...
  if (playerNum) {
    ...
    if (currentTurn === 1) {
      ...
      $("#player1").css("border", "5px solid yellow");
      ...
      // Shows yellow border around active player
      $("#player2").css("border", "5px solid yellow");
